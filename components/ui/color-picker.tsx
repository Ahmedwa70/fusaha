...
export const ColorPicker = ({
  ...
  // Update color when controlled value changes. Syncs internal
  // hue/saturation/lightness/alpha (needed for the hue/alpha sliders) from an
  // externally-controlled `value` prop; there's no derived-state alternative
  // since these are independent pieces of state the sliders write to directly.
